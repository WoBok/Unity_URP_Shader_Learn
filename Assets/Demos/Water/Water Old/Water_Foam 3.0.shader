Shader "Demo/Water/Water_Foam 3.0" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag(VertexOutput IN) : SV_Target {
                ...
                real depth = SampleSceneDepth(screenPosNorm.xy);
                float screenDepth170 = LinearEyeDepth(depth, _ZBufferParams);
                ...
                float4 waterAlbedo155 = lerp(lerpResult121, float4(1, 1, 1, 0), foamNoise114);
                ...
                float screenDepth234 = LinearEyeDepth(depth, _ZBufferParams);
