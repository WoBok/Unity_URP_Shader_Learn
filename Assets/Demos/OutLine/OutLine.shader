Shader "HunagSiPu/Outline" {
    Properties {
        ...
        _OutlinIntensity ("Outline Intensity", float) = 0.9
        _Width ("OutlineWidth", float) = 0.2
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 Fragment(Varyings input) : SV_Target {
                ...
                float factor = pow((1 - saturate(dot(normalize(input.normalWS), normalize(input.viewDirWS)))), _OutlinIntensity);
                factor = 1 - factor;
