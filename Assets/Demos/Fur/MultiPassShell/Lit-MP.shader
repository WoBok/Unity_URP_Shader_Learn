Shader "Universal Render Pipeline/Fur/Multi-Pass Shell/Lit" {
    ...
    Properties {
        ...
        [Space][Header(Emissions)][Space]
        [Toggle]_EnableEmission ("Enable Emission", Float) = 1
        _EmissionMap1 ("Emission Map", 2D) = "white" { }
        [HDR]_EmissionColor ("Emission Color", Color) = (0, 0, 0, 0)
    }

    SubShader {
        Tags {
            "RenderPipeline" = "UniversalPipeline" "RenderType" = "Opaque" "IgnoreProjector" = "True" "Queue" = "AlphaTest"
        ...
        Pass {
            ...
            #pragma shader_feature _ENABLEEMISSION_ON
