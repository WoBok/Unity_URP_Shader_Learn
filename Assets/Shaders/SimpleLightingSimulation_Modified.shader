Shader "Light/Simple Lighting Simulation_Modified" {
    Properties {
        ...
        _ViewX ("ViewX", Range(-1, 1)) = 0
        _ViewY ("ViewY", Range(-1, 1)) = 0
        _ViewZ ("ViewZ", Range(-1, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag(Varyings IN) : SV_Target {
                ...
                float3 worldLightDir = float3(_LightX, _LightY, _LightZ);
                ...
                float3 viewDir = float3(_ViewX, _ViewY, _ViewZ);
