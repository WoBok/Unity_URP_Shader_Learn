Shader "Water/Water_Reflection_Normal" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag(Varyings IN) : SV_Target {
                ...
                half3 finalCol = reflectionProbeResult + reflectionCol.xyz * _ReflectionIntensity; //lerp(mainCol, reflectionCol, _ReflectionIntensity);
                color*=3;
                return half4( finalCol*color, 1) ;
